...
public class SearchItemService extends AsyncTask<Void, Void, Item[]> {
    ...
    public SearchItemService(HomeActivity context, String query) {
    ...
    protected Item[] doInBackground(Void... params) {
        ...
        final String url = context.getString(R.string.url)+"search/item";
        RestTemplate restTemplate = new RestTemplate();
        restTemplate.getMessageConverters().add(new StringHttpMessageConverter());
        restTemplate.getMessageConverters().add(new GsonHttpMessageConverter());
        try {
            Item meals[] = restTemplate.getForObject(url, Item[].class, query);
