...
//        recyclerView.setAdapter(adapter);
        ...
        GetRecommendedService getRecommendedService = new GetRecommendedService(this,username,recyclerView,progressBar,swipeRefreshLayout);
    ...
    public void onRefresh() {
        GetRecommendedService getRecommendedService = new GetRecommendedService(this,username,
